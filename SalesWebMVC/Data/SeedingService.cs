...
namespace SalesWebMVC.Models
{
    public class SeedingService
    {
        ...
        // esse método é chamado lá na Startup no método Configure
        public void Seed()
        {
            // verifica se existe registros nas tabelas Department, Seller e SalesRecord
            if (_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                // se já existe algum registro, ele não vai popular, então da um early return
                return; // DB has been seeded
            }

            // se chegou aqui, é porque nenhuma tabela foi populada ainda
            ...
            // adiciona os objetos na tabela Department
            _context.Department.AddRange(d1, d2, d3, d4);

            // adiciona os objetos na tabela Seller
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            // adiciona os objetos na tabela SalesRecord
